...
param_grid_gb = {'n_estimators': [50,100], 'max_depth': [3,5]},
...
models= {
    ...
    'DecisionTree': (SVR(), param_grid_svr)
}
...
# Comparing with individual model
...
print(f"Final MAE : { final_mae} , Final R^2 : { final_r2}")
